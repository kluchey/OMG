...
- # OMG Hello 👋 #.v-self-border
	...
	- "**Explain it like I'm a Grade 9**" I write this resource by assuming the user has or is developing a Grade 9 understanding of math. Later years in high school are built up from Grade 9.
	- My **goal** for this resource is a useful reference, effective learning tool, and Study Guide such as ==[active recall]([[Study Guide]])== and ==[focused practice]([[Study Guide]])== of our in-school lessons, and as a reference and learning tool used when absent from class.
