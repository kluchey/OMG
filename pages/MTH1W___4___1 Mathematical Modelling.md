...
- ## Warm Up #.v-self-border-children
	...
	- ### Complete this next one on your own.
		- John has a weirdly large number of tooth brushes.
			- If we add 5 more to John's amount and then double it, we get the size of Rahoul's significantly larger collection of tooth brushes.
				- Even more impressive is Zach's collection which is ten times larger than Rahoul's minus one tooth brush, which he recently lost in a freak tooth whitening incident in Hillsburgh, ON at 2:30 AM Tuesday.
		- If together, John, Rahoul, and Zach have 1305 tooth brushes, how many tooth brushes must Cooper have?
