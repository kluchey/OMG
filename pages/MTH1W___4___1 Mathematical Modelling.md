...
- ## Consolidation
	- Which problems require **Algebra** to model and which can be modelled with **Number Sense** alone? Solve each problem first and then **categorize** each as needing Algebra or Number Sense.
	  logseq.order-list-type:: number
		- To estimate the population of elephants in Kenya, aerial photographs are recorded. It is a well known in Kenya that Maasai Mara National Reserve has three times more el
		  logseq.order-list-type:: number
