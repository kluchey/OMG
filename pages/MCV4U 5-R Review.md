# Review Problem Set
	- Topic:  Forms of Equations in 3D
	  logseq.order-list-type:: number
		...
		- Why is there no scalar equation for a line in $\R^3$? Hint: 
		  logseq.order-list-type:: number
		   Can you draw a diagram to explain what problems someone would have forming a scalar equation of a line in 3D?